...
* Task List
** TODO add a type field to resource
This would probably be an enumeration that could be a
...
If opening a file leads to a directory,

But, it should be easy to add an elisp function to open
